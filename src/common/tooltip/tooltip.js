...
export function showByCursor(el, e, offsets = [0, 0]) {
...
export function showBy(el, target, offsets = [0, 0], align = "bottom") {
  el.style.display = "block";
...
export function getContextMenu(items, destroyIfExist = false) {
...
export function createTooltip(id, arrow = "arrow-down") {
...
export function getTooltip(items, arrow = "arrow-down") {
